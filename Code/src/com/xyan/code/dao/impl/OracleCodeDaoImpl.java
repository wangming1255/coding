...
public class OracleCodeDaoImpl implements CodeDao{
	...
	public String getTableColumn(String tableName,String schema) {
		return " select t.table_name as \"tableName\",t.COLUMN_NAME as \"columnName\",t.data_length as \"dataLength\",t.DATA_TYPE as \"dataType\",t.DATA_PRECISION as \"dataPrecision\",cc.comments as \"columnComments\" from all_tab_columns  t "
				+" left join  user_col_comments cc on cc.table_name=t.TABLE_NAME and cc.column_name=t.COLUMN_NAME where t.Table_Name='"+tableName+"'  ";
	}
